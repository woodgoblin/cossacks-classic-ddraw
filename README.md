...
| Folder | Game |
| --- | --- |
| [btw](btw/README.md) | Cossacks: Back to War |

European Wars, Art of War, and later titles belong in sibling folders when those presets exist.

Installer, presets, and docs: MIT. DDrawCompat is downloaded from upstream at install time (LGPL, Narzoul). Cossacks remains GSC Game World's.
